...
const DisplayCity = () => {
  ...
  return (
    <div className='mt-4 mb-[40px] text-white text-[13px] font-bold leading-[28px] tracking-[3px] uppercase md:mb-[70px] md:text-[18px] md:tracking-[3.6px] lg:text-[24px] lg:tracking-[4.8px] lg:inline lg:mt-6'>
